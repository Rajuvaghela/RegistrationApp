...
package com.xtensolution.core.ui.decoration;
...
//        leftOffset = ResourceUtils.getDimen(context, R.dimen.common_48_dp);
//        leftOffset += ResourceUtils.getDimen(context, R.dimen.activity_horizontal_margin) * 2;
//        a.recycle();
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        try {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                mDivider.setBounds(leftOffset, top, right, bottom);
                mDivider.draw(c);
            }
        } catch (Exception e) {
