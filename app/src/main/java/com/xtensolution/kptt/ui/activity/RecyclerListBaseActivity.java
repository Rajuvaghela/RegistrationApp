...
public abstract class RecyclerListBaseActivity<T> extends CoreRecyclerActivity implements OnCallExecuted<Response<List<T>>> {


    private static final String TAG = RecyclerListBaseActivity.class.getSimpleName();
