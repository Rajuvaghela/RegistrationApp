...
/**
 * Created by riontech2 on 9/3/18.
 */
...
//        prefManager.setFirstTimeLaunch(false);
        PreferenceHelper.getInstance().save(Constants.WELCOME_SLIDE,true);
//        startActivity(new Intent(WelcomeActivity.this, LoginActivity.class));
        startActivity(new Intent(WelcomeActivity.this, WorkSpaceActivity.class));
        finish();
    }
