...
/**
 * Created by riontech2 on 10/5/18.
 */
    ...
    public static String convertToIndianCurrency(String num) {
        ...
        while (i < digits_length) {
            ...
            if (number > 0) {
                ...
                String tmp = (number < 21) ? words.get(Integer.valueOf((int) number)) + " " + digits[counter] +
                        plural : words.get(Integer.valueOf((int) Math.floor(number / 10) * 10)) + " "
